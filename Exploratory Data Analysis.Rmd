...
```
* From the above scatter plots and correlation matrix we can say there is a positive linear correlation between median_income and median_house_value attributes.
